...
namespace IbhayiPharmacy.Data
{
    public class ApplicationDbContext : IdentityDbContext<IdentityUser> 
    {
        ...
        //        new Supplier { SupplierID = 1, SupplierName = "NovaCure", ContactName = "Davie", ContactSurname = "Jones", EmailAddress = "davie@example.com", ContactNumber="123456789" },
        //        new Supplier { SupplierID = 2, SupplierName = "HelixMed", ContactName = "Nicky", ContactSurname = "Mostert", EmailAddress = "nmostert@mandela.ac.za", ContactNumber = "123456789" },
        //        new Supplier { SupplierID = 3, SupplierName = "VitaGenix", ContactName = "Matimu", ContactSurname = "Vuqa", EmailAddress = "matimu@example.com", ContactNumber = "123456789" },
        //        new Supplier { SupplierID = 4, SupplierName = "Apex Biomed", ContactName = "Lulu", ContactSurname = "Ndhambi", EmailAddress = "lulu@example.com", ContactNumber = "123456789" },
        //        new Supplier { SupplierID = 5, SupplierName = "CuraNova", ContactName = "Pharmacy Manager Group Member Name", ContactSurname = "Pharmacy Manager Group Member Surname", EmailAddress = "Pharmacy Manager Group Member E-mail", ContactNumber = "123456789" }
        //    );
        ...
        //        new Medication { MedicationID = 1, MedicationName = "CardioVex", Schedule = "6", CurrentPrice = 150, DosageFormID = 1, SupplierID = 1, ReOrderLevel = 100, QuantityOnHand = 90 },
        //        new Medication { MedicationID = 2, MedicationName = "Neurocalm", Schedule = "2", CurrentPrice = 200, DosageFormID = 1, SupplierID = 2, ReOrderLevel = 110, QuantityOnHand = 100 },
        //        new Medication { MedicationID = 3, MedicationName = "Allerfree Duo", Schedule = "0", CurrentPrice = 180, DosageFormID = 12, SupplierID = 3, ReOrderLevel = 150, QuantityOnHand = 100 },
        //        new Medication { MedicationID = 4, MedicationName = "GastroEase", Schedule = "3", CurrentPrice = 95, DosageFormID = 1, SupplierID = 4, ReOrderLevel = 400, QuantityOnHand = 470 },
        //        new Medication { MedicationID = 5, MedicationName = "Respivent", Schedule = "3", CurrentPrice = 120, DosageFormID = 1, SupplierID = 5, ReOrderLevel = 300, QuantityOnHand = 490 }
        //        //new Medication { MedicationID = 6, MedicationName = "Dermagard", Schedule = "3", CurrentPrice = 85, DosageFormID = 1, SupplierID = 2, ReOrderLevel = 600, QuantityOnHand = 790 },
        //        //new Medication { MedicationID = 7, MedicationName = "Metaborex", Schedule = "4", CurrentPrice = 210, DosageFormID = 1, SupplierID = 2, ReOrderLevel = 200, QuantityOnHand = 250 },
        //        //new Medication { MedicationID = 8, MedicationName = "Sleeptraze", Schedule = "2", CurrentPrice = 175, DosageFormID = 1, SupplierID = 2, ReOrderLevel = 100, QuantityOnHand = 110 },
        //        //new Medication { MedicationID = 9, MedicationName = "OsteoFlex", Schedule = "3", CurrentPrice = 300, DosageFormID = 3, SupplierID = 2, ReOrderLevel = 200, QuantityOnHand = 210 },
        //        //new Medication { MedicationID = 10, MedicationName = "Immunexin", Schedule = "6", CurrentPrice = 450, DosageFormID = 9, SupplierID = 2, ReOrderLevel = 200, QuantityOnHand = 190 },
        //        //new Medication { MedicationID = 11, MedicationName = "CardioPlus", Schedule = "6", CurrentPrice = 600, DosageFormID = 11, SupplierID = 2, ReOrderLevel = 500, QuantityOnHand = 600 },
        //        //new Medication { MedicationID = 12, MedicationName = "AllerCalm", Schedule = "6", CurrentPrice = 350, DosageFormID = 11, SupplierID = 2, ReOrderLevel = 400, QuantityOnHand = 410 },
        //        //new Medication { MedicationID = 13, MedicationName = "RespirAid", Schedule = "6", CurrentPrice = 280, DosageFormID = 9, SupplierID = 2, ReOrderLevel = 100, QuantityOnHand = 100 },
        //        //new Medication { MedicationID = 14, MedicationName = "DermaClear", Schedule = "6", CurrentPrice = 125, DosageFormID = 5, SupplierID = 2, ReOrderLevel = 100, QuantityOnHand = 200 },
        //        //new Medication { MedicationID = 15, MedicationName = "OsteoPrime", Schedule = "6", CurrentPrice = 190, DosageFormID = 2, SupplierID = 2, ReOrderLevel = 100, QuantityOnHand = 400 }
        //    );
